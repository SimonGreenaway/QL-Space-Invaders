...
clean:
	rm -f image.o screen.o libimage.a interrupt.o invaders.o invaders.img invaders.zip image.s invaders.mdv invaders.hfe inv
...
run:   	deploy
	#cd /home/simon/emulators/ql/emulators/sQLux && ./sqlux --SPEED=0.20 --RAMSIZE=300 --SOUND 8 -b "OPEN #8,con_512x256a0x0_0:CLS #8:INK #8,4:LRESPR flp1_sigext_rext:EW flp1_invaders,#8;'-d flp1_'"
...
dist:	convert
	...
	cp inavers /home/simon/emulators/ql/emulators/sQLux/flp1
